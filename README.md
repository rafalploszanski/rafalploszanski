### Hello World ?
I am a programmer fullstack  from Poland. Working on multiple frontend and backend project using Python and Django. 
Solving problems and having a great time doing it.

<br><h4>Connect with me</h4></br>
